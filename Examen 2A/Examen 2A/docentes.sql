...
--
-- Host: localhost    Database: docentes
-- ------------------------------------------------------
...
CREATE TABLE `docentebatiz` (
  `noempleado` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `docentebatiz` WRITE;
/*!40000 ALTER TABLE `docentebatiz` DISABLE KEYS */;
INSERT INTO `docentebatiz` VALUES (1,'Jaime','Minor','Gomez','12345678');
/*!40000 ALTER TABLE `docentebatiz` ENABLE KEYS */;
UNLOCK TABLES;
